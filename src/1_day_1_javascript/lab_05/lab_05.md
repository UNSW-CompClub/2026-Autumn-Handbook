# Lab — Random Forest (500)

## What You'll Make

In this exercise, you'll create a sketch of a forest which is randomly generated each time. Grass, flowers and trees are generated as random emojis in random positions. By the end, you will have a beautiful random forest which re-generates itself each time the sketch is drawn!
...
- Use for loops to print repeated text in a row
- Use a nested for loop to print repeated text in multiple rows and columns
- Use the random() function to randomly choose items from an array
- Use the random() function to randomly choose the position of an item
